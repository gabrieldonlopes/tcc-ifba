from schemas import User,PcInfo, MachineResponse
...
def transform_reponse(new_user: User) -> MachineResponse:
    return MachineResponse(session_start=get_session_start(),
                           user=new_user,
