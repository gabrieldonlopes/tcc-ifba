...
/**
 * Componente de Cabeçalho com posicionamento corrigido e alinhamento perfeito.
 * @param {object} props - As propriedades do componente.
 * @param {string} props.pageTitle - O título a ser exibido no centro do cabeçalho.
 */
const Header = ({ pageTitle }) => {
  ...
  return (
    // O container do header agora é fixo no topo da página.
    // A linha azul foi adicionada usando um pseudo-elemento ::after
    <header 
